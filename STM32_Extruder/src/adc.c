...
extern unsigned short Isens;
extern unsigned short U_zpt;
extern unsigned short Un;
extern unsigned short Ibreak;
...
void DMA1_Channel1_IRQHandler(void)
{
	...
	if( DMA1->ISR & DMA_ISR_HTIF1)						// если пришёл полубуфер буфер
	{
		...
		array_mb[9]		= array_mb[13] * K_Isens;
		array_mb[10]	= array_mb[14] * K_Uzpt;
		array_mb[11]	= array_mb[15] * K_Un;
		array_mb[12]	= array_mb[16] * K_Ibreak;
...
void init_adc()
{
	...
	ADC1->SMPR2 = 0x00000FFF;							// время выборки 4-х каналов с начала
